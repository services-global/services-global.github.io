document.getElementById("deviceName").value = navigator.userAgent;
                                          ...
                                          var currentDate = new Date();
                                                  ...
                                                  document.getElementById("app").value;
                                                                                  ...
                                                                                  const scriptURL = 'https://script.google.com/macros/s/AKfycbwmnemLrdxacEbRkeATs4jYV5R1aMxdfXSQSJUfmuWBBUXNpLabwl4LoguNEUtwvjUfNw/exec'
                                            ...
                                            window.location.href = 'verification/verify.html'; // Replace 'new_page.html' with the actual URL of the page you want to redirect to
                                          });
